...
- group: 대만 종목
- url: https://checkapi.koscom.co.kr/ext/m198hist
...
F18061	INT	종목별입회일	(주의 *) 입회일 칼럼이 타 시장(F12506)과 다릅니다.
F16013	CHAR	단축코드	
...
, { "key": "jcode", "value": "2330.TW" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/ext/m198/hist_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
