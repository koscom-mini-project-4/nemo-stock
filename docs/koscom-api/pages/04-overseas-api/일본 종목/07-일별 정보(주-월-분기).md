...
- group: 일본 종목
- url: https://checkapi.koscom.co.kr/ext/m195termhist
...
Example
    ...
    python 
      ...
      api_url = '/ext/m195/term_hist_info'
...
, { "key": "jcode", "value": "7134.T" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/ext/m195/term_hist_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
