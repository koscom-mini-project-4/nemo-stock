...
- group: 미국 지수
- url: https://checkapi.koscom.co.kr/ext/m184termhist
...
Example
    ...
    python 
      ...
      api_url = '/ext/m184/term_hist_info'
...
, { "key": "jcode", "value": ".DJA" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/ext/m184/term_hist_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
