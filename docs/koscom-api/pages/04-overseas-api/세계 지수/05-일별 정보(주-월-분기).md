...
- group: 세계 지수
- url: https://checkapi.koscom.co.kr/ext/m193termhist
...
Example
    ...
    python 
      ...
      api_url = '/ext/m193/term_hist_info'
...
, { "key": "jcode", "value": ".AORD" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/ext/m193/term_hist_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
