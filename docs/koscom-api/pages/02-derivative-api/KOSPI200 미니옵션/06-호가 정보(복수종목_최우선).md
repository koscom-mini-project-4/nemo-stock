...
- category: 파생-API
- group: KOSPI200 미니옵션
- url: https://checkapi.koscom.co.kr/future/m104hogaporttop
...
URL
    ...
    POST /future/m104/hoga_info_port_top
...
Example
    ...
    python 
      ...
      api_url = '/future/m104/hoga_info_port_top'
...
, { "key": "codelist", "value": "'005930', '069500'" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/future/m104/hoga_info_port_top',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
