...
- category: 파생-API
- group: KOSDAQ150 옵션
- url: https://checkapi.koscom.co.kr/future/m180intra
...
Example
    ...
    python 
      ...
      api_url = '/future/m180/intra_info'
...
, { "key": "jcode", "value": "206S4001" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/future/m180/intra_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
