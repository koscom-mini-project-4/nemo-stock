...
- category: 파생-API
- group: 주식 선물(통계정보)
- url: https://checkapi.koscom.co.kr/future/m093basic
...
Example
    ...
    python 
      ...
      api_url = '/future/m093/basic_info'
...
, { "key": "jcode", "value": "STKFUT005930" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/future/m093/basic_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
