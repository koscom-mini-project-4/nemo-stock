...
- url: https://checkapi.koscom.co.kr/future/m235oldcode
...
Example
    ...
    python 
      ...
      api_url = '/future/m235/old_code_info'
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/future/m235/old_code_info', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
