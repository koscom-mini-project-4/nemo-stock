...
- category: 파생-API
- group: USD 선물(야간)
- url: https://checkapi.koscom.co.kr/future/m238code
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/future/m238/code_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
