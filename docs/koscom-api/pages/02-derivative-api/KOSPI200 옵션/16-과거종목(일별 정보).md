...
- category: 파생-API
- group: KOSPI200 옵션
- url: https://checkapi.koscom.co.kr/future/m006oldhist
...
URL
    ...
    POST /future/m006/old_hist_info
...
Example
    ...
    python 
      ...
      api_url = '/future/m006/old_hist_info'
...
, { "key": "jcode", "value": "301S3325" }, { "key": "sdate", "value": 20230101 }, { "key": "edate", "value": 20231231 }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/future/m006/old_hist_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
