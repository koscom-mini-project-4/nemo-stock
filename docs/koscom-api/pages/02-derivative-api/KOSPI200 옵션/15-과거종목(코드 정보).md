...
- category: 파생-API
- group: KOSPI200 옵션
- url: https://checkapi.koscom.co.kr/future/m006oldcode
...
URL
    ...
    POST /future/m006/old_code_info
...
Example
    ...
    python 
      ...
      api_url = '/future/m006/old_code_info'
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/future/m006/old_code_info', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
