...
- category: 기타-API
- group: GAAP
- url: https://checkapi.koscom.co.kr/comp/compgaap
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/gaap/comp_gaap', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
