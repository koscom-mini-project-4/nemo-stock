...
- category: 기타-API
- group: GAAP
- url: https://checkapi.koscom.co.kr/comp/compgaaphist
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/gaap/comp_gaap_hist', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
