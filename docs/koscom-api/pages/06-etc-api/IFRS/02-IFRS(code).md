...
- category: 기타-API
- group: IFRS
- url: https://checkapi.koscom.co.kr/comp/compifrscode
...
Example
    ...
    python 
      ...
      api_url = '/etc/ifrs/comp_ifrs_code'
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/ifrs/comp_ifrs_code', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
