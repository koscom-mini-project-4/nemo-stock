...
- category: 기타-API
- group: IFRS
- url: https://checkapi.koscom.co.kr/comp/compifrsitem
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/ifrs/comp_ifrs_item', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
