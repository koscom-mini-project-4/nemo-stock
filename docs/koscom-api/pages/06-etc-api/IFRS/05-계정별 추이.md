...
- category: 기타-API
- group: IFRS
- url: https://checkapi.koscom.co.kr/comp/compifrshist
...
icode	String	계정코드 6자리 (ex : 110000)	O
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/ifrs/comp_ifrs_hist', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
