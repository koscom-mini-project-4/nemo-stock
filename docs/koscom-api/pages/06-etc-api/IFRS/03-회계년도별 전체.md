...
- category: 기타-API
- group: IFRS
- url: https://checkapi.koscom.co.kr/comp/compifrs
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/ifrs/comp_ifrs', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
