...
- category: 기타-API
- group: IFRS
- url: https://checkapi.koscom.co.kr/comp/compperfdate
...
START_DT	NUMERIC(8)	시작일	
END_DT	NUMERIC(8)	종료일	
FST_PUB_DT	NUMERIC(8)	실적치발표일	
PF_DT	NUMERIC(8)	잠정치발표일	
...
Example
    ...
    python 
      ...
      api_url = '/etc/ifrs/comp_perf_date'
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/ifrs/comp_perf_date', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
