...
- category: 기타-API
- group: 기업정보
- url: https://checkapi.koscom.co.kr/comp/compsales
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/comp/comp_sales', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
