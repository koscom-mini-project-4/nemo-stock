...
- category: 기타-API
- group: 기업정보
- url: https://checkapi.koscom.co.kr/comp/compmarkethist
...
URL
    ...
    POST /etc/comp/comp_market_hist
...
Example
    ...
    python 
      ...
      api_url = '/etc/comp/comp_market_hist'
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/comp/comp_market_hist', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
