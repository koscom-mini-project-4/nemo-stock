...
- category: 기타-API
- group: 금융기관 수신고
- url: https://checkapi.koscom.co.kr/trend/trendsecu
...
STOCK_COM_DEPOSIT_AMT	INT	(증권사)예탁금	
STOCK_COMRP	INT	(증권사)RP	
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/trend/trend_secu', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
