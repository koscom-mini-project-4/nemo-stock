...
- category: 기타-API
- group: 금융기관 수신고
- url: https://checkapi.koscom.co.kr/trend/trendbank
...
BANK_DEMAND_DEPOSIT	INT	(은행)요구불예금	
BANK_SAVINGS_DEPOSIT	INT	(은행)저축성예금	
BANKCD_ISSUE	INT	(은행)CD순발행	
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/trend/trend_bank', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
