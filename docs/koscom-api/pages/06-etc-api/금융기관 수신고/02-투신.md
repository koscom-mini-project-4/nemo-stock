...
- category: 기타-API
- group: 금융기관 수신고
- url: https://checkapi.koscom.co.kr/trend/trendinv
...
IVTRST_BMF	INT	(투신)MMF	
IVTRST_SORTTERM_CSTRU_FRN	INT	(투신)단기채권형	
IVTRST_LOND_BOND	INT	(투신)장기채권형	
IVTRST_STOCK_COMPOUND	INT	(투신)주식혼합형	
IVTRST_BOND_COMPOUND	INT	(투신)채권혼합형	
IVTRST_STOCK_DEPOSIT	INT	(투신)주식형	
IVTRST_TRUST_DEPOSIT	INT	(투신)신탁형 저축	
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/trend/trend_inv', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
