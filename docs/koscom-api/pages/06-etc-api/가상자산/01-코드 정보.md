...
- category: 기타-API
- group: 가상자산
- url: https://checkapi.koscom.co.kr/etc/m215code
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/ext/m215/code_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
