...
- category: 기타-API
- group: 컨센서스
- url: https://checkapi.koscom.co.kr/comp/compconsitem
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/etc/cons/comp_cons_item', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
