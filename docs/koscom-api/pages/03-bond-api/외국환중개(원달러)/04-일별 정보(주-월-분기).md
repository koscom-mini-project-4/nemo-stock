...
- category: 채권-API
- group: 외국환중개(원달러)
- url: https://checkapi.koscom.co.kr/bond/m023termhist
...
Example
    ...
    python 
      ...
      api_url = '/bond/m023/term_hist_info'
...
, { "key": "jcode", "value": "11USDSP" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/bond/m023/term_hist_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
