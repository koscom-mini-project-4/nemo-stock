...
- category: 채권-API
- group: 해외환율
- url: https://checkapi.koscom.co.kr/bond/m174hist
...
, { "key": "jcode", "value": "GBUS10Y" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/ext/m174/hist_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
