...
- category: 채권-API
- group: RFR(무위험지표금리)
- url: https://checkapi.koscom.co.kr/bond/m037basic
...
, { "key": "jcode" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/bond/m037/basic_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
