...
- category: 채권-API
- group: 채권발행정보
- url: https://checkapi.koscom.co.kr/bond/m058ukbuyback
...
ISSUE_NAME_K_ABBR	VARCHAR(20)	한글종목약명	
MID_REDEMP_DATE	CHAR(8)	중도상환일	
AMT	NUMERIC(10)	거래대금	
AFT_CHG_ISSUE_CODE	CHAR(12)	변경후종목코드	
...
Example
    ...
    python 
      ...
      api_url = '/bond/m058/m058ukbuyback'
...
, { "key": "jcode" }, { "key": "sdate", "value": 20230101 }, { "key": "edate", "value": 20231231 }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/bond/m058/m058ukbuyback',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
