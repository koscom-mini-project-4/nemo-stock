...
- category: 채권-API
- group: 채권발행정보
- url: https://checkapi.koscom.co.kr/bond/m058creditgroup
...
URL
    ...
    POST /bond/m058/credit_group_info
...
F16251	CHAR(7)	신용그룹코드	
F18081	CHAR(30)	신용그룹한글명	
...
Example
    ...
    python 
      ...
      api_url = '/bond/m058/credit_group_info'
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/bond/m058/credit_group_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
