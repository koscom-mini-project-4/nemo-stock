...
- category: 채권-API
- group: 장내국채
- url: https://checkapi.koscom.co.kr/bond/m161tick
...
, { "key": "jcode", "value": "KR103501GFC3" }

    javascript 
    
      axios.post('https://checkapi.koscom.co.kr/bond/m161/tick_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
