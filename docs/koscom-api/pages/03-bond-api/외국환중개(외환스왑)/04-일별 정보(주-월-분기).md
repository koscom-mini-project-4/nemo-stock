...
- category: 채권-API
- group: 외국환중개(외환스왑)
- url: https://checkapi.koscom.co.kr/bond/m026termhist
...
Example
    ...
    python 
      ...
      api_url = '/bond/m026/term_hist_info'
...
, { "key": "jcode", "value": "12USD1M" }

    javascript 
    
      axios.post('https://checkapi.koscom.co.kr/bond/m026/term_hist_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
