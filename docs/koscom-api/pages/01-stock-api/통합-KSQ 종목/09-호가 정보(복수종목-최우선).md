...
- category: 주식-API
- group: 통합-KSQ 종목
- url: https://checkapi.koscom.co.kr/stock/m225hogaporttop
...
URL
    ...
    POST /stock/m225/hoga_info_port_top
...
Example
    ...
    python 
      ...
      api_url = '/stock/m225/hoga_info_port_top'
...
, { "key": "codelist", "value": "'005930', '069500'" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/stock/m225/hoga_info_port_top',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
