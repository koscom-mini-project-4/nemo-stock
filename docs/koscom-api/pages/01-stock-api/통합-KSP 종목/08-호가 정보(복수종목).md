...
- category: 주식-API
- group: 통합-KSP 종목
- url: https://checkapi.koscom.co.kr/stock/m224hogaport
...
URL
    ...
    POST /stock/m224/hoga_info_port
...
Example
    ...
    python 
      ...
      api_url = '/stock/m224/hoga_info_port'
...
, { "key": "codelist", "value": "'005930', '069500'" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/stock/m224/hoga_info_port',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
