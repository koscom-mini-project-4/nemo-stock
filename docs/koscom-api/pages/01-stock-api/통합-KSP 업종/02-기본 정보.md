...
- category: 주식-API
- group: 통합-KSP 업종
- url: https://checkapi.koscom.co.kr/stock/m228basic
...
URL
    ...
    POST /stock/m228/basic_info
  
Parameter
Name	Type	Description	Required
cust_id	String	CHECK 단말 고객번호 10자리 (ex : NS00000001)	O
auth_key	String	API 인증키	O
data_list	String	조회항목 리스트 ( F16013, F16002, F15015 ) / 입력하지 않으면 전체 Data Set 조회	X
...
, { "key": "jcode", "value": "1" }
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/stock/m228/basic_info',
        // sample parameter 입니다. 정상 처리 되지 않습니다.
        {
          cust_id : "NS00000001",
          auth_key : "Y0va9PYmoKiqWJ7oSVFiyIy2aVHq7lXj",
