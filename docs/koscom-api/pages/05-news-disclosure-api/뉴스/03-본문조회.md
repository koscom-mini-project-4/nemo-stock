...
- category: 뉴스/공시-API
- group: 뉴스
- url: https://checkapi.koscom.co.kr/news/newsbody
...
URL
    ...
    POST /news/news/news_body
  
Parameter
Name	Type	Description	Required
cust_id	String	CHECK 단말 고객번호 10자리 (ex : NS00000001)	O
auth_key	String	API 인증키	O
ndate	String	뉴스 일자 8자리 (ex: 20230314)	O
ncode	String	뉴스 코드 12자리 (ex: 220N00000451)	O
Data Set
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/news/news/news_body', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
