...
- category: 뉴스/공시-API
- group: 공시
- url: https://checkapi.koscom.co.kr/gongsi/gongsijong
...
Example
    ...
    javascript 
      ...
      axios.post('https://checkapi.koscom.co.kr/news/gongsi/gongsi_jong', 
        // sample parameter 입니다. 정상 처리 되지 않습니다.
